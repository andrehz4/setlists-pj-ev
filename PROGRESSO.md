...
0. FALTA SÓ A MECÂNICA: (a) trocar tarja da capa "NOTÍCIA"->"CÁPSULA" (buildCoverFrontSvg em slide-image.mjs, CAT_LABELS), (b) integrar as 10 no index.json (site) + fila de publicação, (c) workflow publish-capsula.yml cron 23:00 UTC (20h BRT) que publica 1/dia no IG+FB (reusa publishItems + publishFeedAlbum). Regenerar preview: `node scripts/news/youtube/carrossel-preview.mjs`.
