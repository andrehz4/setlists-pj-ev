...
.tira{display:flex;gap:12px;overflow-x:auto;padding-bottom:10px;margin-bottom:6px;scroll-snap-type:x mandatory}
.tira figure{margin:0;flex:0 0 auto;scroll-snap-align:start}
.tira img{width:250px;border-radius:8px;display:block;border:1px solid #2f3846}
